    ...
    <section className="py-16 sm:py-24 bg-white">
      <Container>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {flyAshWhyConecc.cards.map((card) => (
            <div
              key={card.title}
