...
import { fencingHero } from '../../data/fencingpole.js'

export default function FencingHero() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={fencingHero.image}
          alt={fencingHero.imageAlt}
      ...
      <Container className="relative min-h-[340px] sm:min-h-[400px] lg:min-h-[460px] flex items-center py-12">
        <div className="max-w-2xl rounded-xl2 bg-black/50 p-6 sm:p-10">
          ...
          <p className="text-white/90 text-base sm:text-lg font-semibold mb-8">
            {fencingHero.subtitle}
          </p>

          <div className="flex flex-wrap items-center gap-x-8 gap-y-4">
            <a
              href={fencingHero.primaryCtaHref}
            ...
            >
              <FileText size={18} />
              {fencingHero.primaryCta}
            </a>

            <a
              href={fencingHero.secondaryCtaHref}
